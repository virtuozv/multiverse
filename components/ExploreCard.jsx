  ...
  <motion.div variants={fadeIn('right', 'spring', index * 0.5, 0.75)} className={`relative flex min-w-[170px] ${active === id ? 'lg:flex-[3.5] flex-[10]' : 'lg:flex-[0.5] flex-[2]'} duration-[0.7s] ease-out-flex justify-center items-center`} onClick={() => handleClick(id)}>
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px] ">
        <div className={`${styles.flexCenter} glassmorphism rounded-[24px] mb-[16px] h-[60px] w-[60px]`}>
...
// const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
//   <motion.div variants={fadeIn('right', 'spring', index * 0.5, 0.75)} className={`relative ${active === id ? 'lg:flex-[3.5] flex-[10]' : 'lg:flex-[0.5] flex-[2]'} flex items-center justify-center min-w-[170px] transition-[flex] duration-[0.7s] ease-out-flex cursor-pointer`} onClick={() => handleClick(id)}>
